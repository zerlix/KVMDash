...
<span style="display: flex; align-items: center;">
    <img src="src/assets/kvmdash.svg" alt="KvmDash Logo" width="50" style="margin-right: 10px;" />
    <strong>KVMDash</strong> ist eine moderne Webanwendung, die die Verwaltung von Virtual Machines (VMs) und Linux-Containern (LXC) auf Linux-Systemen ermöglicht. Mit einer benutzerfreundlichen Oberfläche erleichtert KVMDash die Administration und Überwachung von Virtualisierungsumgebungen.
</span>
